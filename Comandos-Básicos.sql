...
--COMANDOS 'MIN' 'MAX' 'SUM' E 'AVG': SÃO FUNCOÇES DE AGREGAGAÇÃO, ONDE ELAS COMBINAM DADOS DE UMA TABELA EM UM RESULTADO SÓ
...
SELECT TOP 10 MAX(linetotal) as "VLOR MAXIMO"
FROM Sales.SalesOrderDetail;
